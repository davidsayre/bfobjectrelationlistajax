...
if ($classAttribute )
{
	...
	//BFC ORB
	if (array_key_exists('default_selection',$class_content)) {
		$parentNodeID = $class_content['default_selection']['node_id'];
	}	
	//BFC ORL
	if (array_key_exists('default_placement',$class_content)) {
		$parentNodeID = $class_content['default_placement']['node_id'];
	}
